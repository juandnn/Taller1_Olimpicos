...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna la nacionalidad del atleta indicado
	 * 
	 * @param nombreAtleta
	 * @return Nacionalidad del atleta indicado, null si el atleta no existe
	 */
		
	public String nacionalidadAtleta(String nombreAtleta) {
		...
		if (ElAtleta != null) {
			...
			nacionalidad = ElAtleta.darPais().darNombre();
